                    ...
                    <div className="form">
                        ...
                        <div className="right-side">
                            ...
                            <form onSubmit={submitForm}>
                                ...
                                <div className="input_text">
                                    <input className={` ${warnpass ? "warning" : ""}`} type={pass} placeholder="Renter Password" name="password" value={inputs.password} onChange={inputEvent} />
                                    <i onClick={Eye} className={`fa ${eye ? "fa-eye-slash" : "fa-eye"}`}></i>
                                </div>
                                <div className="btn">
